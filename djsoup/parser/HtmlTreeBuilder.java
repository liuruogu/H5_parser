...
class HtmlTreeBuilder extends TreeBuilder {
    ...
    // Modified code add to store tag-insertionMode mapping for handling broken <table>
    ...
    // Modified code add to build the tag-insertionMode mapping to predict insertion
    ...
    // Modified code add to reset the parser when <table> tag is broken
    void reset(String name) {
        super.reset();
        this.state = stateMap.get(name);
    }

    // Modified code add to reset the parser caused by broken script tag
    ...
    // Modified code add to insert endTag tokens which are normally ignored
    ...
    // Modified code add to insert startComment tokens
    ...
    // Modified code add to insert endComment tokens
    ...
    void clearStackToTableContext() {
    	// Modified code add "body" to handle broken table tag
