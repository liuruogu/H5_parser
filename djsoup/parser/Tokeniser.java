...
class Tokeniser {
    ...
    Token.StartComment startCommentPending;	// Modified code added
    Token.EndComment endCommentPending;  // Modified code added
...
//    // Modified code add to reset the tokenizer
//    void reset() {
//    	reader.setPos(0);
//    	clearCharBuffer();
